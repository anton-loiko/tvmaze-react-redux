...
.table th {
  ...
  font-weight: normal;
  font-size: 0.8rem;
  color: $primary-color-dark-20;

  border: 1px solid $secondary-color-dark-30;
}
...
.coll-sort.sorted-down.sorted-up::after {
  border-top-color: $primary-color;
...
.table tr:nth-child(2n) {
  background-color: $secondary-color-dark-5;
}

.table .table__row-data:hover {
