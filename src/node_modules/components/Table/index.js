...
export default class Table extends Component {
  state = {
    // dataParsedInArr: this.props.state.dataParsedInArr,
    nameSort: false,
    ratingSort: false
  };
  ...
  handleSortName = () => {
    this.props.onSetDataParsed(
      patternSorting(
      this.props.state.dataParsedInArr,
      this.state.nameSort,
      'str',
      1
    ));
    this.setState({
      ...
      ratingSort: false,
      // dataParsedInAr: this.props.state.dataParsedInArr
    ...
    <Fragment>
      <table className='table' onClick={(event) => this.onClickOnTable(event)}>
        <tbody>
          ...
          {this.props.state.dataParsedInArr.map((el) => {
            return (
              <TableRow
                key={el[0]}
                id={el[0]}
