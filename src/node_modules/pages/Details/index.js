...
export default ({data}) => {
  ...
  let urlID = +myHistory.location.pathname.match(/\d+/g).join();

  console.log(urlID);
  // const item = data[urlID].map((el, i) => {
  //   return <li className='details__item'>el[i]</li>
  // });
    ...
    <div className='details'>
      ...
      <div className="details__wrap">
        ...
        <div className="details__content">
          <img className='details__img' src='https://via.placeholder.com/420x650' alt='img'/>
        ...
        <div className='details__description'>
          ...
          Aliquam eum laudantium maiores maxime nam
          obcaecati officia perferendis quae quod, sapiente?
        </div>
