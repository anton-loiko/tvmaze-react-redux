...
export default (props) => {
  ...
  let data;
    ...
    for (let i = 0; i < Object.keys(props.state.data.responseData).length; i++) {
      if (props.state.data.responseData[i].show.id === urlID) {
        data = props.state.data.responseData[i].show;
      }
    }
